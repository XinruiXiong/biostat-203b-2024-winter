...
mimic_icu_cohort<-mimic_icu_cohort |>
  mutate(across(c(first_careunit, last_careunit, admission_type, discharge_location), ~ fct_lump(., n = 4, other_level = "Other")))|>
  mutate(admission_location = fct_lump(admission_location, n = 3, other_level = "Other"))|>
mutate(race = fct_collapse(race,
                             BLACK = c("BLACK/AFRICAN", "BLACK/CAPE VERDEAN", "BLACK/AFRICAN AMERICAN","BLACK/CARIBBEAN ISLAND"), 
                             HISPANIC = c("HISPANIC/LATINO - GUATEMALAN", "HISPANIC/LATINO - MEXICAN", "HISPANIC/LATINO - SALVADORAN","HISPANIC/LATINO - CUBAN","HISPANIC/LATINO - HONDURAN","HISPANIC/LATINO - COLUMBIAN","HISPANIC/LATINO - CENTRAL AMERICAN","HISPANIC OR LATINO","HISPANIC/LATINO - DOMINICAN","HISPANIC/LATINO - PUERTO RICAN"), 
                             ASIAN = c("ASIAN - ASIAN INDIAN","ASIAN - SOUTH EAST ASIAN","ASIAN - KOREAN","ASIAN","ASIAN - CHINESE"),
                             WHITE = c("WHITE - EASTERN EUROPEAN","WHITE - BRAZILIAN","WHITE","WHITE - RUSSIAN","WHITE - OTHER EUROPEAN"))) |>
  mutate(race = fct_other(race, keep = c("ASIAN", "BLACK", "HISPANIC", "WHITE")))|>
  mutate(los_long = (los >= 2))

```

```{r,eval=T}
tbl_summary(mimic_icu_cohort%>%select(-subject_id,-hadm_id,-stay_id,-admit_provider_id), by = los_long)
```
...
![](Q2example1.png) ![](Q2example2.png)

![](Q2example3.png) **The app.R file is in hw4/mimiciv_shiny folder.**
