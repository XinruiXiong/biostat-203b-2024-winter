...
```{r, eval=F}
# the data is extremely large, and rendering this part will cause vector memory exhausted, so I set eval=F
system.time({
...
rm(csv_read7)# delete the large dataset
...
The running time is displayed above.
